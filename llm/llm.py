    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.provider == "openai":
            ...
            self.url = "https://api.mistral.ai/v1/chat/completions"  # Verify this endpoint
            if not self.api_key:
    ...
    def generate(self, input_text):
        ...
        if self.provider == "openai":
            ...
            try:
                ...
                response.raise_for_status()
                data = response.json()
                return data.get("completion", "No response found.").strip()
            except requests.exceptions.RequestException as e:
            ...
            try:
                ...
                response.raise_for_status()
                data = response.json()
                return data.get("choices", [{}])[0].get("message", {}).get("content", "No response found.").strip()
            except requests.exceptions.RequestException as e:
